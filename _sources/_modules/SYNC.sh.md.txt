...
:language: bash
:linenos:
:caption: SYNC.sh — modo estrito
:name: srcblock-sync-strict-mode
```
...
:language: bash
:linenos:
:caption: SYNC.sh — run_cmd
:name: srcblock-sync-run-cmd
```
...
:language: bash
:linenos:
:caption: SYNC.sh — listas de estações
:name: srcblock-sync-station-lists
```
...
:language: bash
:linenos:
:caption: SYNC.sh — das_codes
:name: srcblock-sync-das-codes
```
...
:language: bash
:linenos:
:caption: SYNC.sh — projects
:name: srcblock-sync-projects
```
...
:language: bash
:linenos:
:caption: SYNC.sh — project_map
:name: srcblock-sync-project-map
```
...
:language: bash
:linenos:
:caption: SYNC.sh — globais
:name: srcblock-sync-globals
```
...
:language: bash
:linenos:
:caption: SYNC.sh — build_code_pattern
:name: srcblock-sync-build-code-pattern
```
...
:language: bash
:linenos:
:caption: SYNC.sh — split_das_codes
:name: srcblock-sync-split-das-codes
```
...
:language: bash
:linenos:
:caption: SYNC.sh — log_debug
:name: srcblock-sync-log-debug
```
...
:language: bash
:linenos:
:caption: SYNC.sh — dia_juliano
:name: srcblock-sync-dia-juliano
```
...
:language: bash
:linenos:
:caption: SYNC.sh — is_station_in_list
:name: srcblock-sync-is-station-in-list
```
...
:language: bash
:linenos:
:caption: SYNC.sh — seleciona_projeto_estacao
:name: srcblock-sync-seleciona-projeto
```
...
:language: bash
:linenos:
:caption: SYNC.sh — obter_ultimo_sinc
:name: srcblock-sync-obter-ultimo-sinc
```
...
:language: bash
:linenos:
:caption: SYNC.sh — prepare_archive
:name: srcblock-sync-prepare-archive
```
...
:language: bash
:linenos:
:caption: SYNC.sh — list_archive_paths
:name: srcblock-sync-list-archive-paths
```
...
:language: bash
:linenos:
:caption: SYNC.sh — extract_dates_from_rasp
:name: srcblock-sync-extract-dates-rasp
```
...
:language: bash
:linenos:
:caption: SYNC.sh — extract_reftek_dates_any_depth
:name: srcblock-sync-extract-reftek-dates
```
...
:language: bash
:linenos:
:caption: SYNC.sh — encontrar_closest_zip
:name: srcblock-sync-encontrar-closest-zip
```
...
:language: bash
:linenos:
:caption: SYNC.sh — comparar_parfiles_com_tolerancia
:name: srcblock-sync-comparar-parfiles
```
...
:language: bash
:linenos:
:caption: SYNC.sh — resumir_auto_substituicoes_parfile
:name: srcblock-sync-resumir-parfiles
```
...
:language: bash
:linenos:
:caption: SYNC.sh — find_reftek_dirs_stream1
:name: srcblock-sync-find-reftek-dirs-stream1
```
...
:language: bash
:linenos:
:caption: SYNC.sh — find_reftek_files_stream0
:name: srcblock-sync-find-reftek-files-stream0
```
...
:language: bash
:linenos:
:caption: SYNC.sh — processar_reftek
:name: srcblock-sync-processar-reftek
```
...
:language: bash
:linenos:
:caption: SYNC.sh — processar_raspberry
:name: srcblock-sync-processar-raspberry
```
...
:language: bash
:linenos:
:caption: SYNC.sh — finalizar_log
:name: srcblock-sync-finalizar-log
```
...
:language: bash
:linenos:
:caption: SYNC.sh — configuração de log
:name: srcblock-sync-config-logging
```
...
:language: bash
:linenos:
:caption: SYNC.sh — CLI usage
:name: srcblock-sync-cli-usage
```
...
:language: bash
:linenos:
:caption: SYNC.sh — CLI getopts
:name: srcblock-sync-cli-getopts
```
...
:language: bash
:linenos:
:caption: SYNC.sh — seleção do contexto
:name: srcblock-sync-select-context
```
...
:language: bash
:linenos:
:caption: SYNC.sh — ano forçado
:name: srcblock-sync-ano-forcado
```
...
:language: bash
:linenos:
:caption: SYNC.sh — seleção automática
:name: srcblock-sync-auto-selection
```
...
:language: bash
:linenos:
:caption: SYNC.sh — atalho REFTEK /sds
:name: srcblock-sync-reftek-shortcut
```
...
:language: bash
:linenos:
:caption: SYNC.sh — dispatch final
:name: srcblock-sync-dispatch
```
